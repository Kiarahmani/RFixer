...
get a solution: (+){0,1}([0-9]){0,13}
  (+){0,1}([0-9]){0,13}           
template: (■){■}(■)* size: 2 holes: 4 time: 2.133157ms
template: ■([0-9])* size: 2 holes: 1 time: 3.711837ms
template: (■){■}([0-9])* size: 3 holes: 3 time: 2.092982ms
template: (■){■}([0-9]){■} size: 3 holes: 5 time: 4.420105ms
longest: #mn#(■){■}([0-9]){■}#mn# size: #ms#3#ms# holes: #mh#5#mh# time: #mt#4.420105#mt#ms
