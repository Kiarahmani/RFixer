...
get a solution: (((([0-9]){4}\-)([0-9]){1,6})\-)([0-9]){2}
  (((([0-9]){4}\-)([0-9]){1,6})\-)([0-9]){2}
template: (((((■){■}){0,3}\-)([0-9]){0,5})■)([0-9]){0,1} size: 7 holes: 4 time: 7.775987ms
template: ((((■){■}\-)([0-9]){0,5})■)([0-9]){0,1} size: 6 holes: 4 time: 1.465406ms
template: (((([0-9]){■}\-)([0-9]){■})\-)([0-9]){■} size: 8 holes: 6 time: 1.466277ms
longest: #mn#(((((■){■}){0,3}\-)([0-9]){0,5})■)([0-9]){0,1}#mn# size: #ms#7#ms# holes: #mh#4#mh# time: #mt#7.775987#mt#ms
