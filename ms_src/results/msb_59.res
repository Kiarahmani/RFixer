...
template: ((((\{■)(■)*)\})\})+ size: 5 holes: 2 time: 0.648061ms
template: ((((\{■)(.)*)\})\})+ size: 6 holes: 1 time: 0.780134ms
template: ((((\{■)(.){■})\})\})+ size: 6 holes: 3 time: 1.009376ms
template: ((((\{\{)(.)*)■)\})+ size: 6 holes: 1 time: 0.705608ms
template: ((((\{\{)(■)*)■)\})+ size: 5 holes: 2 time: 0.599639ms
template: ((((\{\{)(■)*)\})\})+ size: 6 holes: 1 time: 0.883749ms
template: ((((\{\{)(.){■})\})\})+ size: 7 holes: 2 time: 0.963496ms
template: ((((\{\{)(■)*)\})■)+ size: 5 holes: 2 time: 0.88422ms
template: ((((■\{)(.){■})\})\})+ size: 6 holes: 3 time: 0.952544ms
template: ((((■\{)(.)*)\})\})+ size: 6 holes: 1 time: 0.750216ms
template: ((((\{\{)(■)*)\})\}){■} size: 6 holes: 3 time: 1.704404ms
template: (((((■){■}\{)(.)*)\})\})+ size: 7 holes: 3 time: 1.034832ms
template: ((((\{\{)(.)*)\})■)+ size: 6 holes: 1 time: 0.720849ms
template: ((((\{(■){■})(.)*)\})\})+ size: 7 holes: 3 time: 1.520547ms
template: ((((\{\{)(.)*)\})\}){■} size: 7 holes: 2 time: 0.77067ms
template: ((((\{(■■))(.)*)\})\})+ size: 6 holes: 2 time: 0.824122ms
template: ((((\{\{)(■){■})\})\})+ size: 6 holes: 3 time: 1.735962ms
template: ((((■\{)(.)*)\})\}){■} size: 6 holes: 3 time: 0.693405ms
template: ((((■■)(.)*)\})\})+ size: 5 holes: 2 time: 0.917902ms
template: ((((■\{)(■)*)\})\})+ size: 5 holes: 2 time: 0.824354ms
template: ((((\{■)(.)*)■)\})+ size: 5 holes: 2 time: 0.819472ms
template: ((((\{■)(.)*)\})\}){■} size: 6 holes: 3 time: 0.735483ms
template: ((((\{■)(.)*)\})■)+ size: 5 holes: 2 time: 0.75835ms
template: ((((■\{)(.)*)■)\})+ size: 5 holes: 2 time: 0.656616ms
template: ((((■\{)(.)*)\})■)+ size: 5 holes: 2 time: 0.571884ms
longest: #mn#((((\{\{)(■){■})\})\})+#mn# size: #ms#6#ms# holes: #mh#3#mh# time: #mt#1.735962#mt#ms
